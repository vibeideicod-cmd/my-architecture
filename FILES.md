...
| [irina/](irina/) | активный контур Ирины | Партнёрское направление: стратегия + брендбук + портфолио + продукты + deliverables. После миграции 2026-05-17 объединено из бывшей `clients/irina/`. Локальная карта [irina/FILES.md](irina/FILES.md). |
...
> Заметка: `inna/` и `irina/` — это Контур 1 «Мой бизнес», не клиенты. Поэтому в этой таблице активных клиентов они не упоминаются. См. раздел «Контуры работы» ниже.
...
| Ирина | `irina/` | Партнёрское направление, бренд-дизайн, портфолио, продукты Ирины. После миграции 2026-05-17 объединено из бывшей `clients/irina/`. |
