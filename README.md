...
📖 Подбренд «Нейро Бабки» относится к Фазе 2 — материалы лежат в `ideas/neuro-babki/`. Папка `clients/neuro-babki/` была архивирована 2026-05-17 как пустая (см. `_архив-возможно-удалить/`).
