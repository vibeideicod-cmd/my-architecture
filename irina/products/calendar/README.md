...
**Автор пакета:** Systems · **Дата:** 2026-05-04 (v2.0, переход на РФ-стек) · **Связано с:** `irina/visitka-v3/spec/INTERACTIONS-MAP.md` (П3, Развилка 2 → вариант A), `legal/PD-AUDIT.md`.
