...
> **Источники:** `irina/brandbook/palette.md`, `typography.md`, `ui-components.md`, `logo-and-graphics.md`, `dont.md`, `tov-source.md`, `architecture.md`, `architecture-decisions.md`, `brandbook-pdf-brief.md`.
...
8 цветов из её брендбука. Источник: `irina/brandbook/palette.md`.
...
Источник: `irina/brandbook/typography.md`.
...
Зафиксировано в `irina/brandbook/dont.md` (главы 3, 4, 6) и `ui-components.md` §13. Здесь — короткий чек-лист для верстальщика:
...
- `irina/brandbook/palette.md` — полный гид по цветам с психологией и архетипами
- `irina/brandbook/typography.md` — детальная типографика
- `irina/brandbook/ui-components.md` — кнопки, формы, карточки, модалки
- `irina/brandbook/logo-and-graphics.md` — логотип, графический язык, паттерны
- `irina/brandbook/dont.md` — антипримеры (полный список запретов)
- `irina/tov-source.md` — голос Ирины (для текстов на визитке)
- `knowledge/standards/visual-techniques.md` — каталог CSS-приёмов команды (§1, §2, §5, §6, §8)
- `irina/CLAUDE.md` — юр.правила проекта Ирины
